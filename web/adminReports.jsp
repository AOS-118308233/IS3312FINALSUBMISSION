<%-- 
    ...
    Created on : 6 Feb 2021, 19:53:29
    Author     : aoife
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="column">
                    <img src="resources/images/SalesUnits.png" alt="Forest" style="width:100%">
                </div>
                <div class="column">
                    <img src="resources/images/TotalCosts.png" alt="Forest" style="width:100%">
                </div>
            </div>    
        </div>
