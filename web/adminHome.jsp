...
<html>
    <head>      
        ...
        <!-- JavaScript code -->
        <link rel="stylesheet" type="text/css" href="resources/JS/list.js">
       
        <!-- jQuery -->
        <script type="text/javascript" src="resources/vendor/Lib/jquery-3.5.1.min.js"></script>
        ...
        <div class="container" id="AdminHome">
            ...
            <div>
                ...
                <div class="container" id="adminList" style="width:400px; height:300px">
                    <div class="toDo">
                        <h1 class="list">Admin To Do<i class="fa fa-plus" id="addButton"></i></h1>
                        <input type="text" placeholder="Add New To Do" id="toDo">
                        <ul class="adminToDo">
