            ...
            <div class="col-lg-3">
                <div class="container" id="categories">
                    ...
                    <div class="list-group">
                        <a href="ProductServlet" class="list-group-item active" id="categoryAll">All Products</a>
                        <c:forEach items="${categories}" var="name">
                            <a href="CategoryServlet?category=${name}" class="list-group-item active" id="categorybutton">${name}</a>
                        </c:forEach> 
                    </div>
                </div>
